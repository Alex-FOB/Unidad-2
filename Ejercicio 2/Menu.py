...
class menu:
    ...
    def opción2(self, op, i): #segundo menú
        ...
        if self.__funcion:
            ...
            print('ERROR: opcion invalida')
        input()
    def punto1(self): #busca el viajero en la lista para luego manipular sus datos
        ...
        if (i != -1):
            ...
            input()
    def consultar(self, i): #muestra las millas del viajero
        print('Millas acumuladas: {}'.format(self.__control.consultar(i)))
    def acumular(self, i): #suma las millas ingresadas con las del viajero y muestra el resultado
        millas = int(input('Millas acumular: '))
        print('Millas totales: {}'.format(self.__control.acumular(i, millas)))
    def canjear(self, i): #resta las millas con las ingresadas y las del viajero y muestra el resultado
    ...
    def salir(self, i = 0):
        print('FINALIZANDO...')
        input()
    def cerrar(self): #cierra el archivo
